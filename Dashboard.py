...
def mostrar_menu():
    ...
    # Agregadas las unidades 3 y 4 al diccionario de unidades
    unidades = {
        '1': 'Unidad 1',
        '2': 'Unidad 2',
        '3': 'Unidad 3',  # Agregada la Unidad 3
        '4': 'Unidad 4'   # Agregada la Unidad 4
    }
    ...
    while True:
        ...
        # Permite al usuario elegir una unidad o salir
        eleccion_unidad = input("Elige una unidad o '0' para salir: ")
        if eleccion_unidad == '0':
            print("Saliendo del programa.")
            break
        elif eleccion_unidad in unidades:
            # Llama a mostrar_sub_menu con la ruta correspondiente a la unidad elegida
            mostrar_sub_menu(os.path.join(ruta_base, unidades[eleccion_unidad]))
        else:
            # Si la opción no es válida, le informa al usuario
